<template>
  <div class="upload-layout">
    <div class="upload-title-layout" :class="[buttonSize ? 'text-layout-' + buttonSize : '']">
      <p v-if="!isFitWidthProp" class="title-layout" :style="{ width: `${this.titleWidth}px` }">
        <span v-if="isMustProp" class="must-flag-layout">*</span>{{ title }}
      </p>
      <p v-else class="title-layout" :class="[{ 'title-width-fit-layout': isFitWidthProp }]">
        <span v-if="isMustProp" class="must-flag-layout">*</span>{{ title }}
      </p>
    </div>
    <div>
